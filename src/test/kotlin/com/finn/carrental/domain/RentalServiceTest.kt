...
class RentalServiceTest {
    ...
    fun `createRental() Should add A Rental`() {
        ...
        // when
        val rental = rentalService.createRental("64c8c410bebeef1000d78c80", "64c8fb032eb57e0b2626907c",
            LocalDateTime.of(2023, 8, 20, 12, 0),
            LocalDateTime.of(2023, 8, 25, 12, 0))

        // then
        val expectedRental = Rental("64c8c410bebeef1000d78c80",
    ...
    fun `createRentalInABlockedTimeperiod() Should Throw an AlreadyRentedException`() {
        ...
        every { carRepository.findOneById(any()) } returns CarEntity(ObjectId("64c8fb032eb57e0b2626907c"), "Audi", "A5", 5)
        every { userRepository.findOneById(any()) } returns UserEntity(ObjectId("64c8c410bebeef1000d78c80"), "Finn", "Hoffmann", "fihoffmann@web.de")
        every { rentalRepository.findByCarEntity(any()) } returns listOf(RentalEntity(
        ...
        assertThrows<AlreadyRentedException> {
            // when
            rentalService.createRental("64c8c410bebeef1000d78c80", "64c8fb032eb57e0b2626907c",
